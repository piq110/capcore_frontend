    ...
    <Container maxWidth="lg" sx={{ py: { xs: 4, sm: 6, md: 8 } }}>
      ...
      >
        ...
        <Typography variant="body1" sx={{ fontWeight: 500, color: 'primary.contrastText' }}>
          Contact us at support@capitalcore.finance
        </Typography>
      </Box>
    </Container>
  )
